...
import static com.systematictesting.media.AudioFormatKeys.*;
import static com.systematictesting.media.VideoFormatKeys.*;
...
public class DefaultRegistry extends Registry {
    ...
    protected void init() {
        ...
        putBidiCodec(
                ...
                "com.systematictesting.media.avi.AVIPCMAudioCodec");
        putBidiCodec(
        ...
        putCodec(
                ...
                "com.systematictesting.media.quicktime.QuickTimePCMAudioCodec");
        putCodec(
                new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_JAVA, EncodingKey, ENCODING_PCM_UNSIGNED),
                new Format(MediaTypeKey, MediaType.AUDIO, MimeTypeKey, MIME_QUICKTIME, EncodingKey, ENCODING_QUICKTIME_TWOS_PCM),
                "com.systematictesting.media.quicktime.QuickTimePCMAudioCodec");
        ...
        putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI), "com.systematictesting.media.avi.AVIReader");
        putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME), "com.systematictesting.media.quicktime.QuickTimeReader");
        putReader(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_ANIM), "com.systematictesting.media.anim.ANIMReader");
        putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI), "com.systematictesting.media.avi.AVIWriter");
        putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME), "com.systematictesting.media.quicktime.QuickTimeWriter");
        putWriter(new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_ANIM), "com.systematictesting.media.anim.ANIMWriter");
