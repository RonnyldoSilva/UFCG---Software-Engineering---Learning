...
public class AbstractQuickTimeStream {
	...
	protected abstract class Track {
		...
		protected void writeSampleTableAtoms(CompositeAtom minfAtom) throws IOException {
			...
			int sampleUnit = mediaType == MediaType.AUDIO && ((AudioTrack) this).soundCompressionId != -2
					? ((AudioTrack) this).soundSampleSize / 8 * ((AudioTrack) this).soundNumberOfChannels : 1;
